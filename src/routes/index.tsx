    ...
    <main className="min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <section id="inicio" className="relative flex min-h-[92svh] items-end bg-carbon">
        ...
        <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-5 pb-16 pt-36 md:grid-cols-[1fr_320px] md:items-end md:px-10 md:pb-20">
          ...
          <div className="border-l-2 border-primary pl-6">
            ...
            <Button asChild variant="architectural" size="lg"><Link to="/proyectos">Ver proyectos <ArrowRight /></Link></Button>
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-5 md:px-10">
          ...
          <div className="mt-10">
            <Button asChild variant="architectural" size="lg"><Link to="/servicios">Todos los servicios <ArrowRight /></Link></Button>
          </div>
        </div>
      </section>
      ...
      <section className="bg-primary py-20 md:py-28">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 md:grid-cols-[0.8fr_1.2fr] md:px-10">
          ...
          <div><h2 className="max-w-3xl text-4xl font-extrabold leading-tight text-primary-foreground sm:text-5xl">Cada proyecto comienza por escuchar el lugar.</h2><p className="mt-7 max-w-2xl text-base leading-relaxed text-primary-foreground/75">Somos un estudio de arquitectura enfocado en soluciones precisas, responsables y duraderas. Diseñamos desde la realidad del clima, la ciudad y las personas que habitan cada espacio.</p>
            <div className="mt-8"><Button asChild variant="outline" size="lg"><Link to="/estudio">Conocer el estudio <ArrowRight /></Link></Button></div>
          </div>
        </div>
      </section>
